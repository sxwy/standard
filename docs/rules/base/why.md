...
<img src="/standard/images/rules_base_why_1.png" style="zoom:67%;" />
...
<img src="/standard/images/rules_base_why_2.png" style="zoom:67%;" />
...
下面以 vue-cli 为例，用来讲解代码规范

## 2、使用 vue-cli 创建项目

使用 vue-cli 创建项目

我们需要创建一个 `vue3` 的项目，而创建项目的方式依然是通过 `vue-cli` 进行创建。
...
> <img src="/standard/images/rules_base_why_3.png" style="zoom:67%;" />
> 这个错误表示：
...
1. 在 `VSCode` 中安装 `prettier` 插件（搜索 `prettier`），这个插件可以帮助我们在配置 `prettier` 的时候获得提示
   <img src="/standard/images/rules_base_why_4.png" style="zoom:50%;" />
...
4. 打开 `VSCode` 《设置面板》
   <img src="/standard/images/rules_base_why_5.png" style="zoom:67%;" />

5. 在设置中，搜索 `save` ，勾选 `Format On Save`
   <img src="/standard/images/rules_base_why_6.png" style="zoom:67%;" />
...
<img src="/standard/images/rules_base_why_7.png" style="zoom:67%;" />
...
![image-20210904203051754](/standard/images/rules_base_why_8.png)
...
## 9、使用 husky + commitlint 检查提交描述是否符合规范要求
...
![image-20210710121456416](/standard/images/rules_base_why_9.png)
...
2. 启动 `hooks` ， 生成 `.husky` 文件夹
   ...
   ![image-20210906202034156](/standard/images/rules_base_why_10.png)
...
3. 在 `package.json` 中生成 `prepare` 指令（ **需要 npm > 7.0 版本** ）
   ...
   <img src="/standard/images/rules_base_why_11.png" style="zoom:50%;" />
...
5. 执行成功，提示
   <img src="/standard/images/rules_base_why_12.png" style="zoom:80%;" />
...
7. 此时的 `.husky` 的文件结构
   ![image-20210710120228931](/standard/images/rules_base_why_13.png)
...
2. 该操作会生成对应文件 `pre-commit`：
   ![image-20210906204043915](/standard/images/rules_base_why_14.png)
...
2. [commitlint](https://github.com/conventional-changelog/commitlint)：用于检查提交信息
3. `pre-commit`： `git hooks` 钩子
4. [lint-staged](https://github.com/okonet/lint-staged)：只检查本次修改更新的代码，并在出现错误的时候，自动修复并且推送
